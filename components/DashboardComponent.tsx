...
export default function DashboardComponent() {
    ...
    const StatCard = ({ label, total, lastMonth, Icon, iconBg }: any) => (
            ...
            <div className="flex flex-wrap gap-4">
                ...
                <div className="flex-1 min-w-[260px] bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
                    <div className="flex justify-between items-center px-4 py-3 border-b border-neutral-800">
                        ...
                        <Link href="/dashboard?tab=users" className="text-blue-500 hover:text-blue-400 text-xs transition-colors">
                            See all
                        </Link>
                    </div>
                ...
                <div className="flex-1 min-w-[260px] bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
                    <div className="flex justify-between items-center px-4 py-3 border-b border-neutral-800">
                        ...
                        <Link href="/dashboard?tab=comments" className="text-blue-500 hover:text-blue-400 text-xs transition-colors">
                            See all
                        </Link>
                    </div>
                    <table className="w-full text-sm">
                ...
                <div className="flex-1 min-w-[260px] bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
                    <div className="flex justify-between items-center px-4 py-3 border-b border-neutral-800">
                        ...
                        <Link href="/dashboard?tab=posts" className="text-blue-500 hover:text-blue-400 text-xs transition-colors">
                            See all
                        </Link>
                    </div>
                    <table className="w-full text-sm">
